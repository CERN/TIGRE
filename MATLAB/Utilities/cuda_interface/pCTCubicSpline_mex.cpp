...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs,const mxArray *prhs[]){
    ...
    detectorDistanceIn = (float*) mxGetPr(prhs[8]);
    detectorDistanceOut = (float*) mxGetPr(prhs[9]);
    initEnergy = (float*) mxGetPr(prhs[10]);
    hullParams = (float*) mxGetPr(prhs[11]);
    
    int hull_len = (int) mxGetM(prhs[11]);
    ...
    ParticleProjections(outProjections, posIn, posOut, dirIn, dirOut, Wepl ,numOfProtons, detectorSizeX, detectorSizeY, *pixelSize, *detectorDistanceIn, *detectorDistanceOut, *initEnergy, hullParams);
