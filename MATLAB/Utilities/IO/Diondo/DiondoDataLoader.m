function [proj,geo,angles]=DiondoDataLoader(filepath,varargin)
...
[geo,angles]=readDiondoGeometry(filepath);
[proj,geo,angles]=loadDiondoProjections(filepath,geo,angles,varargin{:});
