...
if contains(computer('arch'),'64')
    ...
    mex('-largeArrayDims', './Utilities/cuda_interface/ApplyFbpFiltration.cpp', '../Common/CUDA/FbpFiltration.cu', '../Common/CUDA/GpuIds.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
    mex('-largeArrayDims', './Utilities/cuda_interface/ApplyPaddingAndFbpFiltration.cpp', '../Common/CUDA/FbpFiltration.cu', '../Common/CUDA/GpuIds.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
    ...
    mex( './Utilities/cuda_interface/ApplyFbpFiltration.cpp', '../Common/CUDA/FbpFiltration.cu', '../Common/CUDA/GpuIds.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
    mex( './Utilities/cuda_interface/ApplyPaddingAndFbpFiltration.cpp', '../Common/CUDA/FbpFiltration.cu', '../Common/CUDA/GpuIds.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
