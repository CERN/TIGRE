function [x,errorL2,qualMeasOut]= LSMR_lambda(proj,geo,angles,niter,varargin)
...
for ii=1:niter
    ...
    % if ii >= 1 decided against it. Malena.
...
%% parse inputs'
function [verbose,x,QualMeasOpts,gpuids,redundancy_weights, lambda]=parse_inputs(proj,geo,angles,argin)
opts=     {'init','initimg','verbose','qualmeas','gpuids','redundancy_weighting','lambda'};
