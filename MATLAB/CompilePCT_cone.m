%Compile pCT forward projection (cone beam geometry)
...
% Safety copy
% try 
%    if isempty(dir('improvedForwardProjections_orig.hpp'))
%        copyfile('improvedForwardProjections.hpp', 'improvedForwardProjections_orig.hpp')
%    end
% catch
...
if isunix
    if ~isempty(strfind(computer('arch'),'64'))
        % mex -setup C++ -largeArrayDims pCTCubicSpline_cone_mex.cpp improvedForwardProjections_cone.cu -outdir ./pCTMexFiles/linux64
