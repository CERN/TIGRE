...
imgFISTA_hyper = algs.fista(noise_projections,geo,angles,100,hyper=2.e6)

## Recon more significant tv parameters
imgFISTA_hightv = algs.fista(noise_projections,geo,angles,100,hyper=2.e6,tviter=100,tvlambda=20)


## Plot results
tigre.plotimg(np.concatenate([imgFISTA_default,imgFISTA_hyper,imgFISTA_hightv],axis=1),dim='z',clims=[0,1])
