...
imgASDPOCS=algs.asd_pocs(noise_projections,geo,angles,10, \
                     # these are very important
                     tviter=ng,maxl2err=epsilon,alpha=alpha, \
                     # less important.
                     lmbda=lmbda,lmbda_red=lambdared,rmax=ratio,verbose=verb)
...
imgOSASDPOCS=algs.os_asd_pocs(noise_projections,geo,angles,10, \
                     # these are very important
                     tviter=ng,maxl2err=epsilon,alpha=alpha, \
                     # less important.
                     lmbda=lmbda,lmbda_red=lambdared,rmax=ratio,verbose=verb,
...
imgAWASDPOCS=algs.awasd_pocs(noise_projections,geo,angles,10, \
                     # these are very important
                     tviter=ng,maxl2err=epsilon,alpha=alpha, \
                     # less important.
                     lmbda=lmbda,lmbda_red=lambdared,rmax=ratio,verbose=verb,\
