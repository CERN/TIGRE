...
geo.offDetector=np.vstack([10*np.sin(angles), 20*np.cos(angles)]).T                    # Offset of Detector            (mm)
...
geo.offDetector=np.vstack([10*np.sin(angles), 10*np.cos(angles)]) .T                                               # Offset of Detector            (mm)
geo.offOrigin =np.vstack([40*np.sin(angles), np.linspace(-30,30,100), 40*np.cos(angles)]).T                     # Offset of image from origin   (mm)              
