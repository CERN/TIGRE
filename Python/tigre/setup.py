...
Ax_ext = Extension('_Ax',
                   sources=(['Source/projection.cpp',
                             'Source/Siddon_projection.cu', 'Source/Siddon_projection_parallel.cu',
                             'Source/ray_interpolated_projection.cu', 'Source/ray_interpolated_projection_parallel.cu',
                             'Source/_types.pxd',
                             'Source/_Ax.pyx']),
...
Atb_ext = Extension('_Atb',
                    sources=(['Source/voxel_backprojection.cu', 'Source/voxel_backprojection2.cu',
                              'Source/voxel_backprojection_parallel.cu',
                              'Source/_types.pxd',
                              'Source/_Atb.pyx']),
                    library_dirs=[CUDA['lib64']],
                    libraries=['cudart'],
