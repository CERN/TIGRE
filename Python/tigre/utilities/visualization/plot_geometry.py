...
#PLOTGEOMETRY(GEO,ANGLES,POS, OBS) plots a simplified version of the CBCT geometry with the
# given geomerty GEO and scanning angles ANGLES at position POS. If angles is 
# not given, [0,2pi] at 100 steps will be given, and pos=0 will be chosen. 
# 
